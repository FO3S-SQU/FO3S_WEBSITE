...
When the user provides a video file (MP4, MOV, etc.) and wants a scroll-driven animated website from it. Also use when the user asks for a "video scroll site", "frame-by-frame scroll animation", or "scroll-driven product reveal".
